...
namespace TarodevController
{
    ...
    public class PlayerController : MonoBehaviour, IPlayerController
    {
        ...
        private void CheckCollisions()
        {
            ...
            {
                _stats.MaxSpeed = _stats.GroundMaxSpeed;
                _stats.Acceleration = _stats.GroundAcceleration;
                _grounded = true;
                _coyoteUsable = true;
            ...
            {
                _stats.MaxSpeed = _stats.AirMaxSpeed;
                _stats.Acceleration = _stats.AirAcceleration;
                _grounded = false;
